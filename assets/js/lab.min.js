...
function buildLabOrderDisplay() {
    ...
    var heads = ['Accession#','Test name', 'Specimen', 'Ordered', 'Result', 'Released', 'Reprint'];
    ...
    for (var x = 0; x < orders.length; x++) {
        ...
        for(let i = 0; i <  tests.length; i++){
            ...
            orders_table.row.add([accession_number, tests[i].name, test_status,
                date_ordered, results_arr.join('<br />'), result_date, addPrintBTN(orders[x].order_id)]).node().id = "lab-order-" + (i+1);
            orders_table.draw();
