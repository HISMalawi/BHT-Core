    ...
    for (var x = 0; x < orders.length; x++) {
        ...
        for(let i = 0; i <  tests.length; i++){
            ...
            if (results_arr.length != 0) {
                results_arr[0] = "Pedding";
            } else {
                results_arr[0] = '<button class="button blue navButton" onclick="ordersPopupModal()"><span>View</span></button>'
            }
            ...
            console.log("status: ",results_arr);
...
function ordersPopupModal() {
    ...
    nextButton.setAttribute('onmousedown','closeOrdersPopupModal()');
