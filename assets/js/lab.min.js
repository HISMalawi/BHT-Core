...
function changeCancelBTN() {
  ...
  if (sessionStorage.lab_is_set == 'true') {
    ...
    c.setAttribute('onmousedown','closeOrdersPopupModal()');
    return;
  }
...
function buildLabOrderDisplay() {
    ...
    var heads = ['Accession#','Test name', 'Specimen', 'Order date', 'Result', 'Result date'];
    ...
    for (var x = 0; x < orders.length; x++) {
        ...
        for(let i = 0; i <  tests.length; i++){
            ...
            for(let r = 0; r < results.length; r++) {
               ...
               let value_modifier = results[r].value_modifier;
